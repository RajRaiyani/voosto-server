...
import { ValidationSchema as RegisterNewUserValidationSchema, Controller as RegisterNewUserController } from '@/modules/user/controllers/registerNewUser.js';
import { ValidationSchema as VerifyRegistrationValidationSchema, Controller as VerifyRegistrationController } from '@/modules/user/controllers/verifyRegistration.js';
import { ValidationSchema as LoginUserValidationSchema, Controller as LoginUserController } from '@/modules/user/controllers/loginUser.js';
import { ValidationSchema as ForgotPasswordValidationSchema, Controller as ForgotPasswordController } from '@/modules/user/controllers/forgotPassword.js';
import { ValidationSchema as ResetPasswordValidationSchema, Controller as ResetPasswordController } from '@/modules/user/controllers/resetPassword.js';
import { ValidationSchema as ForgotPasswordOtpValidationSchema, Controller as ForgotPasswordOtpController } from '@/modules/user/controllers/forgotPasswordOtp.js';
import { ValidationSchema as VerifyForgotPasswordOtpValidationSchema, Controller as VerifyForgotPasswordOtpController } from '@/modules/user/controllers/verifyForgotPasswordOtp.js';
...
import { Controller as ListFriendsController } from '@/modules/user/controllers/listFriends.js';
...
import { ValidationSchema as LoginWithGoogleValidationSchema, Controller as LoginWithGoogleController } from '@/modules/user/controllers/loginWithGoogle.js';
