...
import { ValidationSchema as ListConversationsSchema, Controller as ListConversationsController } from '@/components/conversation/controllers/listConversations.js';
import { ValidationSchema as GetConversationSchema, Controller as GetConversationController } from '@/components/conversation/controllers/getConversation.js';
import { ValidationSchema as UpdateConversationSchema, Controller as UpdateConversationController } from '@/components/conversation/controllers/updateConversation.js';
import { ValidationSchema as ListMessagesSchema, Controller as ListMessagesController } from '@/components/conversation/controllers/listMessages.js';
import { ValidationSchema as SendMessageSchema, Controller as SendMessageController } from '@/components/conversation/controllers/sendMessage.js';
import { ValidationSchema as GetPrivateConversationSchema, Controller as GetPrivateConversationController } from '@/components/conversation/controllers/getPersonalConversation.js';
import { ValidationSchema as JoinConversationSchema, Controller as JoinConversationController } from '@/components/conversation/controllers/joinConversation.js';
import { ValidationSchema as AcceptJoiningRequestSchema, Controller as AcceptJoiningRequestController } from '@/components/conversation/controllers/acceptJoiningRequest.js';
import { ValidationSchema as LeaveConversationSchema, Controller as LeaveConversationController } from '@/components/conversation/controllers/leaveConversations.js';
